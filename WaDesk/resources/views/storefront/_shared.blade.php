...
<style>
    ...
    #sf-modal [data-modal-card] {
        ...
        /* Scroll the dialog itself on short (mobile) viewports — the tall
           checkout form was centered with no height cap, so its bottom (the
           "Place order" button) fell off-screen and couldn't be reached,
           especially once the keyboard opened. dvh tracks the real visible
           height as mobile browser chrome / keyboard appears. */
