                    ...
                    <div class="bg-paper-0 border border-paper-200 rounded-2xl shadow-card overflow-hidden">
                        ...
                        <div class="p-4 space-y-3 text-[12px] text-ink-700">
                            ...
                            <div>
                                ...
                                <p class="text-ink-600 mt-0.5">
                                    {{ __('Access tokens last ~1 hour and refresh automatically; refresh tokens are stored encrypted per workspace. Google only returns a refresh token with access_type=offline + prompt=consent, which :brand always sends.', ['brand' => brand_name()]) }}
                                </p>
                            </div>
                            <div>
