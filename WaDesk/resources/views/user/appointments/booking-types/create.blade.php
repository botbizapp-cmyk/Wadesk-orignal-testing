<x-layouts.user :title="__('New Booking Type')" nav-key="appointments" page="user-booking-type-wizard">
            ...
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    <div class="font-mono text-[10px] uppercase tracking-[0.16em] text-ink-500">
                        {{ __('Appointments / New') }}</div>
                    <div class="font-serif text-[20px] leading-tight truncate">{{ __('Create a') }} <span
                            class="italic text-wa-deep">{{ __('booking type') }}</span></div>
                </div>
            </div>
