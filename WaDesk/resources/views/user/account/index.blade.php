                        ...
                        <div class="flex items-start justify-between gap-4">
                            <div>
                                ...
                                <p class="text-[12.5px] text-ink-600 mt-2 max-w-md">
                                    {{-- Reward is a single platform-defined value — render it in the
                                         platform's operating currency for EVERY viewer, so it isn't
                                         shown as S$1 to one account and $1 to another (formatIn = no
                                         per-workspace conversion). --}}
                                    {{ __('Share your unique link. Every new sign-up earns you') }} <span
                                        class="text-wa-deep font-semibold">{!! \App\Support\FormatSettings::formatIn((int) $signupReward / 100, (string) \App\Models\SystemSetting::get('default_currency', 'USD')) !!}</span>,
