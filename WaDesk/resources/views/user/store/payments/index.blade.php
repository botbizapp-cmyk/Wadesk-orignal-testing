        ...
        <div class="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6">
            ...
            <section class="space-y-5 min-w-0">
                <div>
                    ...
                    <a href="{{ route('user.store.gateways.index') }}" class="inline-flex items-center gap-1.5 mt-2 text-[12.5px] font-semibold text-wa-deep hover:underline">
                        {{ __('Outside India? Configure hosted checkout gateways (Stripe, Paystack, Flutterwave & 29 more) →') }}
                    </a>
                </div>
