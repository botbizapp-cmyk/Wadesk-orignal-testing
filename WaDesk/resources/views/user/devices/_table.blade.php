...
// hint. We don't have a model field yet, so just show region + a
    ...
    @endphp
    <div class="device-row min-w-[1160px] grid grid-cols-[40px_minmax(200px,1.4fr)_150px_140px_120px_90px_140px_220px] items-center gap-3 px-4 py-3 border-b border-paper-200 last:border-0 hover:bg-paper-50/60"
        data-device-id="{{ $d->id }}">
