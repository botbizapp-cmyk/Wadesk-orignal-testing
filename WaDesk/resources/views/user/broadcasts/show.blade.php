            ...
            <div class="bg-paper-0 border border-paper-200 rounded-2xl shadow-card overflow-hidden">
                <div class="px-5 py-4 border-b border-paper-200 flex items-center justify-between gap-3 flex-wrap">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        <a href="{{ route('user.broadcasts.export', $broadcast->id) }}"
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 border border-paper-200 rounded-full bg-paper-0 hover:bg-wa-mint/40 hover:border-wa-deep hover:text-wa-deep text-[12px] font-semibold">
                            <svg viewBox="0 0 16 16" class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M8 2v8M5 7l3 3 3-3" /><path d="M3 12v1.5h10V12" />
                            </svg>
                            {{ __('Export rows') }}
                        </a>
