...
import lineFlowController from "./controllers/lineFlowController.js";
import wechatFlowController from "./controllers/wechatFlowController.js";
import viberFlowController from "./controllers/viberFlowController.js";
import emailFlowController from "./controllers/emailFlowController.js";
import {
...
app.post("/api/line-flow/inbound", lineFlowController.lineInbound);
app.get("/api/line-flow/health", lineFlowController.lineFlowHealth);
app.post("/api/wechat-flow/inbound", wechatFlowController.wechatInbound);
app.get("/api/wechat-flow/health", wechatFlowController.wechatFlowHealth);
app.post("/api/viber-flow/inbound", viberFlowController.viberInbound);
app.get("/api/viber-flow/health", viberFlowController.viberFlowHealth);
// ── Email (MailTrixy mirror) flow engine (WeChat pattern: every send delegates
//    back to PHP so MailTrixy creds stay server-side). PURELY ADDITIVE.
app.post("/api/email-flow/inbound", emailFlowController.emailInbound);
app.get("/api/email-flow/health", emailFlowController.emailFlowHealth);
