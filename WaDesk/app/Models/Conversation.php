    ...
    public function scopeForCurrentEngine(Builder $q): Builder
    {
        ...
        $sets = \Illuminate\Support\Facades\Cache::remember(
            ...
            function () use ($wsId) {
                ...
                if (\App\Models\LineChannel::hasConnected($wsId))        $agnostic[] = 'line';
                if (\App\Models\WeChatChannel::hasConnected($wsId))      $agnostic[] = 'wechat';
                if (\App\Models\ViberChannel::hasConnected($wsId))       $agnostic[] = 'viber';
                if (\App\Models\WorkspaceEmailAccount::hasConnected($wsId)) $agnostic[] = 'email';
