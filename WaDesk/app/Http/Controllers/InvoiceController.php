...
class InvoiceController extends Controller
{
    public function download(Request $request, int $id)
    {
        ...
        $brand = [
            ...
            // Invoice logo — the dedicated one uploaded at /admin/checkout-settings
            // (billing.logo), falling back to the site brand logo, then null →
            // wordmark fallback.
            'logo'      => \App\Support\Brand::invoiceLogoUrl(),
        ];
